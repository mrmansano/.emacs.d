...
(map!
 ...
 :m "A-j"       '+mrmansano:multi-next-line
 :m "A-k"       '+mrmansano:multi-previous-line
 ...
 (:leader
   ...
   :desc "Find snippet"             :n "S"  '+mrmansano/find-in-snippets
   ...
   (:desc "Personal"
     :prefix "SPC"
     :desc "Browse emacs.d"         :n "." '+mrmansano/browse-emacsd
     :desc "Find file in emacs.d"   :n "/" '+mrmansano/find-in-emacsd
     :desc "Browse dotfiles"        :n ">" '+mrmansano/browse-dotfiles
     :desc "Find file in dotfiles"  :n "?" '+mrmansano/find-in-dotfiles
     :desc "Reload theme"           :n "R" 'doom/reset-theme
     ;; Org notes
     :desc "Browse notes"           :n "n"   '+mrmansano/browse-notes
     :desc "Find file in notes"     :n "N"   '+mrmansano/find-in-notes
